...
{
    public class SceneUnlock4Data : UIPanelData
	{
	}

	public partial class SceneUnlock4 : UIPanel, ICanGetModel, ICanGetUtility, ICanSendEvent
	{
        private const int PANEL_ID = 3;
        ...
        {
              (4, new Vector2(253, 488)),
              (5, new Vector2(-164, 227)),
              (5, new Vector2(218, 244)),
              (6, new Vector2(-77, -242)),
              (6, new Vector2(-312, -337)),
              (6, new Vector2(300, -135)),
              (7, new Vector2(170, 19)),
              (7, new Vector2(-224, -569)),
              (7, new Vector2(0, -541)),
              (8, new Vector2(123, -441)),
              (8, new Vector2(308, -469)),
              (8, new Vector2(-205, -687)),
              (9, new Vector2(0, -367)),
              (10, new Vector2(0, -137))
        };
		...
		{
			mData = uiData as SceneUnlock4Data ?? new SceneUnlock4Data();

    ...
    public static class GameConst
    {
        ...
        public static readonly Dictionary<int, (int bottleIndex_1, int bottleIndex_2, string guideInfo)>
            GameplayTutorialInfo = new()
            {
                ...
                { 221, (-10, -1, "White Cat helps you eliminate one black obstruction per step.") },
                { 301, (0, 1, "Synthesizing a magic book can remove all negative effects") },
                { 401, (2, -1, "The black obstruction on the bottle never disappears; when the bottle is lifted, it reveals the color of the water tiles.") } //18
            };
    }
